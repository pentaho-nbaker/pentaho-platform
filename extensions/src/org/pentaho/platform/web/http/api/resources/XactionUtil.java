...
public class XactionUtil {
  ...
  public static OutputStream getOutputStream(HttpServletResponse response, boolean doMessages) throws ServletException,
      IOException {
  ...
  private static Element createParameterElement(final Element parametersElement, final String paramName,
    ...
    paramGroupAttr
        .addAttribute("namespace", "http://reporting.pentaho.org/namespaces/engine/parameter-attributes/core");
