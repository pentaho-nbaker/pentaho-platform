...
public class DefaultPluginManagerTest {
   ...
   * whereas in test8 the bean definition is being derived from the IPlatformPlugin and being programmatically
  ...
  public void test16_getBeanFromPluginClassloader_usingBeanFactory() throws PluginBeanException, PlatformInitializationException, BeansException {
    ...
    assertNotNull(
        "PluginOnlyClass should be accessible through the bean factory.  Why wasn't it registered there?",
  ...
  public void test17_getPluginIdForType() throws PlatformInitializationException, PluginBeanException {
    IPluginProvider provider = new IPluginProvider() {
      public List<IPlatformPlugin> getPlugins(IPentahoSession session) throws PlatformPluginRegistrationException {
        ...
        BeanDefinition beanDef = BeanDefinitionBuilder.rootBeanDefinition("org.pentaho.test.platform.plugin.pluginmgr.ContentGenerator1").setScope(
  ...
  public static class Tst8PluginProvider implements IPluginProvider {
    public List<IPlatformPlugin> getPlugins(IPentahoSession session) throws PlatformPluginRegistrationException {
      ...
      BeanDefinition beanDef = BeanDefinitionBuilder.rootBeanDefinition("org.pentaho.nowhere.PluginOnlyClass").setScope(
          BeanDefinition.SCOPE_PROTOTYPE).getBeanDefinition();
  ...
  public static class Tst16PluginProvider implements IPluginProvider {
    public List<IPlatformPlugin> getPlugins(IPentahoSession session) throws PlatformPluginRegistrationException {
      PlatformPlugin p = new PlatformPlugin(new DefaultListableBeanFactory());
          BeanDefinition def = BeanDefinitionBuilder.rootBeanDefinition("org.pentaho.nowhere.PluginOnlyClass").getBeanDefinition();
