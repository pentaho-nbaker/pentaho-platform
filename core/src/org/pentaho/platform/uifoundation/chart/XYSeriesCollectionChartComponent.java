...
public class XYSeriesCollectionChartComponent extends AbstractJFreeChartComponent {
  private static final long serialVersionUID = -6268840271596447555L;

  protected String seriesName = null;

  public XYSeriesCollectionChartComponent(final int chartType, final String definitionPath, final int width,
  ...
  public XYSeriesCollectionChartComponent(final String definitionPath, final IPentahoUrlFactory urlFactory,
      final ArrayList messages) {
    super(definitionPath, urlFactory, messages);
  }

  public XYSeriesCollectionChartComponent(final IPentahoUrlFactory urlFactory, final List messages) {
  ...
  public Dataset createChart(final Document doc) {
    ...
    XYSeriesCollectionChartDefinition chartDefinition = new XYSeriesCollectionChartDefinition(
        ...
        if (urlTemplate != null) {
          ...
          if (paramName == null) {
            ...
            try {
              ...
              String itemValueStr = ((XYSeriesCollection) xyItemEntity.getDataset()).getX(seriesIndex, itemIndex)
                  .toString();
