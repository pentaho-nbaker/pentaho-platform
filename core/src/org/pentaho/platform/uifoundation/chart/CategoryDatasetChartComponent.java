  ...
  private void populateCategoryItemEntity(CategoryItemEntity categoryItemEntity, List seriesListArray) {
    ...
    if (paramName == null) {
      ...
      try {
         ...
         * 
         * The entity collection generated by JFreeChartEngine will not always be fully populated 
         * (i.e., the entity collection WILL NOT contain items for values that are zero (0)),
         * because items with zero value do not need to be drawn!  So, we cannot iterate through
         * the seriseListArray and apply values from there to the values in the entity
         * collection.  Instead, we must use the series index contained in the entity record
         * to access the appropriate series name.
         */
