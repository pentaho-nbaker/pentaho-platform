...
public class SolutionEngine extends PentahoMessenger implements ISolutionEngine, IPentahoInitializer {
  ...
  protected IRuntimeContext executeInternal(final String sequencePath,
      final String processId, final boolean async, final boolean instanceEnds,
  ...
  protected IRuntimeContext executeInternal(final String sequencePath, final String processId, final boolean async, final boolean instanceEnds,
    ...
    if (actionSequence == null) {
      ...
      AuditHelper
          .audit(
              session.getId(),
              session.getName(),
              FilenameUtils.getName(sequencePath),
              getObjectName(),
              processId,
